...
Danach erfolgt eine intramolekulare nukleophile Substitution, bei der das Chlor auf den Kohlenstoff der ehemaligen Alkoholfunktion übertragen wird und gleichzeitig \ce{SO_2} abgespalten wird. Es bildet sich  das gewünschte Produkt (\textit{4R,5R})-4,5-Bis(chlordiphenylmethyl)-2,2-dimethyl-1,3-dioxolan (\textbf{8}).\\
